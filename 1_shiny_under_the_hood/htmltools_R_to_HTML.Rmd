...
1. Access its class using `tagGetAttribute` and another method of your choice.
2. Inspect its structure. Hint: you may use `str`.
3. Find its name.
4. Access the first child.
5. Modify the first child class to `custom class`.
6. Add an id attribute to the second child.
